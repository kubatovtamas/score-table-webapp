...
alter table player add constraint FKdvd6ljes11r44igawmpm1mc5s foreign key (team_id) references team (id)
alter table team add constraint FK9rk8716asfr76xkn99aa3uvp foreign key (league_id) references league (id) on delete cascade
create table country (id bigint not null auto_increment, name varchar(255) not null, primary key (id)) type=InnoDB
create table game (id bigint not null auto_increment, date datetime not null, num_away_goals integer not null, num_home_goals integer not null, away_team_id bigint not null, home_team_id bigint not null, primary key (id)) type=InnoDB
create table goal (id bigint not null auto_increment, game_id bigint not null, player_id bigint not null, team_id bigint not null, primary key (id)) type=InnoDB
create table league (id bigint not null auto_increment, name varchar(255) not null, country_id bigint not null, primary key (id)) type=InnoDB
create table player (id bigint not null auto_increment, name varchar(255), team_id bigint, primary key (id)) type=InnoDB
create table team (id bigint not null auto_increment, name varchar(255) not null, league_id bigint not null, primary key (id)) type=InnoDB
alter table country add constraint UK_llidyp77h6xkeokpbmoy710d4 unique (name)
alter table game add constraint UK5s43nppb2bv3x3pop2db39tre unique (away_team_id, home_team_id)
alter table league add constraint UK_n8qcbpi2pjf8bbenfm9le3v36 unique (name)
alter table team add constraint UK_g2l9qqsoeuynt4r5ofdt1x2td unique (name)
